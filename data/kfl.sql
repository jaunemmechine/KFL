SET NAMES 'utf8';
DROP DATABASE IF EXISTS kfl;
CREATE DATABASE kfl CHARSET=UTF8;
USE kfl;
...
INSERT INTO kf_order(oid, phone,user_name,sex,addr,did) VALUES
(NULL,'13501234567','婷婷',2,'长沙市五一路中兴大厦A座',3),
(NULL,'13501234567','婷婷',2,'麓谷大道111号',2),
(NULL,'13501234567','婷婷',2,'荣湾镇交警大楼001房',5);
##SELECT * FROM kf_order;
SELECT* from kf_order INNER JOIN kf_dish on kf_order.did=kf_dish.did ORDER BY oid desc;
CREATE TABLE kfl_user(
